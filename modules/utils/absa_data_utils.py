...
class AeProcessor(DataProcessor):
    ...
    def _create_examples(self, lines, set_type):
        ...
        for (i, ids) in enumerate(lines):
            ...
            text_a = lines[ids]['claims.claimCorrectedText']
            label = lines[ids]['claims.claimTarget.text']
            examples.append(
...
class AscProcessor(DataProcessor):
    ...
    def _create_examples(self, lines, set_type):
        ...
        for (i, ids) in enumerate(lines):
            guid = "%s-%s" % (set_type, ids)
            text_a = lines[ids]['claims.claimTarget.text']
            text_b = lines[ids]['claims.claimCorrectedText']
            label = lines[ids]['claims.claimSentiment']
            examples.append(
